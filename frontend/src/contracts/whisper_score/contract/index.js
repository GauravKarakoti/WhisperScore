...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.privateUserValue) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named privateUserValue');
    }
  ...
  initialState(...args_0) {
    ...
    if (!(typeof(initialThreshold_0) === 'bigint' && initialThreshold_0 >= 0n && initialThreshold_0 <= 4294967295n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 ...
                                 'whisper_score.compact line 8 char 1',
                                 'Uint<0..4294967296>',
                                 initialThreshold_0)
    }
  ...
  _privateUserValue_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.privateUserValue(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 4294967295n)) {
      __compactRuntime.typeError('privateUserValue',
                                 'return value',
  ...
  _checkEligibility_0(context, partialProofData) {
    ...
    const userValue_0 = this._privateUserValue_0(context, partialProofData);
    const isEligible_0 = userValue_0 >= threshold_0;
    const increment_0 = ((t1) => {
                          if (t1 > 4294967295n) {
                            throw new __compactRuntime.CompactError('whisper_score.compact line 24 char 21: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                          }
                          return t1;
                        })(isEligible_0 ? 1n : 0n);
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('whisper_score.compact line 27 char 28: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
...
const _dummyContract = new Contract({
  privateUserValue: (...args) => undefined
});
